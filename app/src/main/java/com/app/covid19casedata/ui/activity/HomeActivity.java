...
import com.app.covid19casedata.databinding.ActivityHomeBinding;
import com.app.covid19casedata.db.DatabaseHelper;
import com.app.covid19casedata.utils.LocaleHelper;
import com.app.covid19casedata.utils.NetworkCheck;
import com.app.covid19casedata.utils.PreferencesManager;
        ...
        customLayout.findViewById(R.id.btn_change).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(mEnglishRBtn.isChecked()){
                    new LocaleHelper().setAppLocale(HomeActivity.this,"en");
                }else{
                    new LocaleHelper().setAppLocale(HomeActivity.this,"fr");
                }
                finalAlert.dismiss();
